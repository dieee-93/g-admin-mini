// =============================================================================
// JOB ROLE TYPES - Job Roles for Labor Costing
// =============================================================================
...
export type JobRoleRow = Database['public']['Tables']['job_roles']['Row'];
...
/**
 * JobRole: Job role for labor costing (TEMPLATE/CATEGORY)
 *
...
export interface JobRole {
  ...
  // Costing Defaults (used as baseline for team members assigned to this role)
...
// =============================================================================
// LABOR COSTING CONFIG (stored in team_policies.labor_costing_config)
// =============================================================================
...
// =============================================================================
// TEAM ALLOCATION (for products)
// =============================================================================

/**
 * Team allocation for a product
 * Defines how much team member time is needed to produce/deliver a product
 */
export interface TeamAllocation {
  id?: string;
  product_id: string;

  // Assignment (role required, team member optional for specific assignment)
  role_id: string;                 // FK to job_roles
  team_member_id?: string | null;  // FK to team_members (optional, more specific)
 ...
 * - Tipo de contratación del team member (dependencia, monotributo, etc.)
 ...
 * Each team member can have their own factor based on their employment type.
 *
 * Sources:
...
// =============================================================================
// EMPLOYMENT TYPES (for TeamMembers)
// =============================================================================
