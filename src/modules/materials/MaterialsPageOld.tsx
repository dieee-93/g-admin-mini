...
// ✅ SUPPLY CHAIN INTELLIGENCE MODULES
...
export function MaterialsPage() {
  ...
  // ✅ Configurar quick actions contextuales basadas en tab activo
  useEffect(() => {
    ...
    switch (activeTab) {
      ...
      case 'abc-analysis':
        quickActions.push({
          ...
          icon: ChartBarIcon,
          action: () => console.log('Run ABC Analysis'),
          color: 'blue'
        });
        break;
        ...
        quickActions.push(
          {
            ...
            action: () => console.log('Generate Smart Orders'),
            color: 'green'
          },
          {
            ...
            action: () => console.log('Procurement Settings'),
            color: 'gray'
          }
        );
        break;
        ...
        quickActions.push(
          {
            ...
            icon: UserGroupIcon,
            action: () => console.log('Score Suppliers'),
            color: 'purple'
          },
          {
            id: 'add-supplier',
      ...
      case 'optimization':
        quickActions.push(
          {
            id: 'run-optimization',
            label: 'Ejecutar Optimización',
            icon: LightBulbIcon,
            action: () => console.log('Run Inventory Optimization'),
            color: 'blue'
          },
          {
            ...
            label: 'Configuración',
            icon: DocumentChartBarIcon,
            action: () => console.log('Forecast Settings'),
            color: 'gray'
          }
        );
        break;
      ...
      case 'alerts':
        quickActions.push(
          {
            id: 'view-critical-alerts',
            label: 'Alertas Críticas',
            icon: BellIcon,
            action: () => console.log('View Critical Alerts'),
            color: 'red'
          },
          {
            id: 'alert-settings',
            ...
            icon: DocumentChartBarIcon,
            action: () => console.log('Alert Settings'),
            color: 'gray'
          }
        );
        break;
        ...
        quickActions.push(
          {
            ...
            icon: DocumentChartBarIcon,
            action: () => console.log('Generate Supply Chain Report'),
            color: 'blue'
          },
          {
            id: 'export-dashboard',
  ...
  }, [setQuickActions, hasAlerts, hasCriticalAlerts, activeTab]);
        ...
        <VStack align="start" gap="3">
          <HStack justify="space-between" w="full">
            <VStack align="start" gap="1">
              ...
              <Text color="gray.600">
                Gestión inteligente de materiales con análisis ABC, procurement y scoring de proveedores
              </Text>
            </VStack>
                    ...
                    <Card.Root variant="outline">
                      <Card.Body p={3}>
                        <HStack justify="space-between">
                          ...
                          <Badge colorPalette={stockDialogItem.current_quantity > stockDialogItem.min_stock ? 'green' : 'red'}>
