...
export const kitchenManifest: LinkModuleManifest = {
  ...
  requiredFeatures: [
    ...
    'production_kitchen_display', // Kitchen-specific feature
  ] as FeatureId[],
  ...
  setup: async (registry) => {
    ...
    try {
      ...
      logger.debug('App', 'Registered kitchen dashboard widget');
  ...
  metadata: {
    /**
     * CRITICAL: Link modules MUST have category: 'integration'
     */
    category: 'integration',
    ...
    /**
     * Links field documents which modules this bridges
     * Helps with documentation and dependency visualization
     */
...
export interface KitchenAPI {
  ...
  getKitchenQueue: () => Promise<{ orders: any[]; count: number }>;
