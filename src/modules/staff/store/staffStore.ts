 ...
 * - Server state (staff[], schedules[], timeEntries[]) → TanStack Query (@/hooks/useStaff)
...
export interface StaffState {
  // ❌ REMOVED: staff[], schedules[], timeEntries[] → use TanStack Query hooks
...
export const useTeamStore = create<StaffState>()(
  devtools(
    persist(
      immer((set) => ({
        // Initial UI state
