...
// Export class wrapper for backward compatibility
export class SchedulingCalculations {
  static calculateShiftHours = calculateShiftHours;
  static calculateShiftCost = calculateShiftCost;
  static calculateStaffingMetrics = calculateStaffingMetrics;
  static calculateEmployeeWorkloads = calculateEmployeeWorkloads;
  static calculateEmployeeSatisfactionScore = calculateEmployeeSatisfactionScore;
  static calculateEmployeeScore = calculateEmployeeScore;
  static calculateConfidenceScore = calculateConfidenceScore;
}
