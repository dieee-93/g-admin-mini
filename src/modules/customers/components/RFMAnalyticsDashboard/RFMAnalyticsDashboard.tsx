                    ...
                    <Card.Body p={4}>
                      <VStack gap={2}>
                        <HStack justify="space-between" width="full">
                          ...
                          <ProgressCircle.Root value={analytics.customer_retention_rate} boxSize="40px">
                            <ProgressCircle.Circle stroke="purple.400" />
            ...
            <Tabs.Content value="customers">
              <VStack align="stretch" gap={4}>
                <HStack justify="space-between">
                  ...
                  <Text fontSize="sm" color="gray.500">Segment filter coming soon</Text>
