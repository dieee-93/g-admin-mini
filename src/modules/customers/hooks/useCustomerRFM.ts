...
import customersAlertsAdapter from '@/pages/admin/core/crm/customers/services/customersAlertsAdapter';
import type { CustomerRFMProfile, CustomerAnalytics } from '@/pages/admin/core/crm/customers/services';
import { CustomerSegment, ChurnRisk } from '@/pages/admin/core/crm/customers/types';
import {
  calculateCustomerRFM,
  getCustomerAnalyticsDashboard,
  getCustomerProfileWithRFM
} from '@/pages/admin/core/crm/customers/services';
