/**
 * EquipmentSelectorInline Component
 *
 * Inline selector for production equipment (no modal)
 * Used within MaterialFormDialog wizard pattern
 */
...
import type { ProductionEquipmentUsage } from './EquipmentSelector';

// ============================================================================
// TYPES
// ============================================================================

export interface EquipmentSelectorInlineProps {
...
export function EquipmentSelectorInline({
  onSelect,
  onCancel,
  selectedEquipmentIds = [],
}: EquipmentSelectorInlineProps) {
...
export default EquipmentSelectorInline;
