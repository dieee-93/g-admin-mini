...
describe('Staff Module Integration Tests', () => {
  ...
  describe('Directory Section Integration', () => {
    it('should load and display teamMembers from API', async () => {
    ...
    it('should handle teamMember creation workflow', async () => {
      ...
      // New teamMember should appear in list
      await waitFor(() => {
        expect(screen.getByText('Carlos Rodríguez')).toBeInTheDocument();
      });
    });

    it('should handle teamMember update workflow', async () => {
      const user = userEvent.setup();
      ...
      // Click edit button for first teamMember
    ...
    it('should handle teamMember deletion workflow', async () => {
      const user = userEvent.setup();
      ...
      // Click delete button for first teamMember
  ...
  describe('Performance Integration', () => {
    it('should maintain performance with large datasets', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByText('TeamMember 0')).toBeInTheDocument();
      });
