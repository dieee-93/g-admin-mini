...
describe('LaborCostDashboard', () => {
  ...
  it('should display all tab options', () => {
    ...
    expect(screen.getByTestId('tab-teamMembers')).toBeInTheDocument();
  ...
  it('should switch between tabs correctly', async () => {
    ...
    // Click teamMembers tab
    await user.click(screen.getByTestId('tab-teamMembers'));

    expect(screen.getByTestId('tab-content-teamMembers')).toBeInTheDocument();
  });

  it('should display teamMember cost data in teamMembers tab', async () => {
    const user = userEvent.setup();
    render(<LaborCostDashboard />);
