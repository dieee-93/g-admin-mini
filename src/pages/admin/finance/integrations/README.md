...
|---------|-----------|-----------|-------------|
| **Integrations Hub** | `/` | `page.tsx` | Gateway status and config. |
| **MercadoPago** | `(tab)` | `MercadoPagoIntegration` | MP settings. |
| **MODO** | `(tab)` | `MODOIntegration` | MODO settings. |
| **QR Setup** | `(tab)` | `QRInteroperableManager` | QR code generator. |
