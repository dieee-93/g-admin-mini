...
import { 
  Layout, Stack, VStack, HStack, Typography, Button, Card, Badge, Center
} from '@/shared/ui';
import { 
  PhoneIcon, 
  MapPinIcon, 
  ...
  return (
    <Layout variant="container" padding="xl">
      <Stack direction="row" align="center" justify="space-between" gap="xl">
        ...
        <Center width="50%">
          <Card variant="elevated" padding="none" rounded>
            <div style={{
              width: '400px',
              height: '300px',
      ...
      <Stack gap="xl">
        ...
        <div style={{ 
          ...
          {featuredItems.map((item) => (
            <Card key={item.id} variant="elevated" padding="md" interactive>
              <Stack gap="md">
      ...
      <Card variant="subtle" padding="xl">
        <Stack direction="row" align="center" gap="xl">
          <Stack gap="lg" width="60%">
            ...
            <HStack gap="md">
              <Card variant="outline" padding="md" width="fit">
      ...
      <Stack gap="xl">
        ...
        <div style={{ 
          ...
          {testimonials.map((testimonial) => (
            <Card key={testimonial.id} variant="outline" padding="lg">
              <Stack gap="md">
