// EventBusTestingHarness.ts - Comprehensive Testing Utilities for EventBus V2
...
export class EventBusTestingHarness {
  ...
  constructor(eventBus?: EventBusV2, testConfig?: Partial<EventBusConfig>) {
    // Create isolated test instance or use provided one
    this.eventBus = eventBus || new EventBusV2({
