 ...
 *
 * Este archivo define TODOS los tokens de diseño del sistema.
...
export const SPACING = {
  ...
  '6': '1.5rem', // 24px - Card padding, section gaps (ESTÁNDAR CARDS)
...
export const SPACING_USAGE = {
  microGap: '1', // 4px - Entre íconos y texto
  buttonGroup: '2', // 8px - Botones en grupo
  formField: '4', // 16px - Entre campos de formulario
  cardPadding: '6', // 24px - Padding interno de cards (ESTÁNDAR)
  sectionGap: '8', // 32px - Entre secciones de página
  majorSection: '12', // 48px - Separadores grandes
  pageHeader: '16' // 64px - Headers de página
} as const;
...
export const BORDER_RADIUS = {
  none: '0',
  sm: '0.125rem', // 2px - Badges pequeños
...
export const SHADOWS = {
  ...
  md: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)', // ESTÁNDAR CARDS
 ...
 * Estos se mapean a los colores del tema activo
 */
...
export const COMPONENT_SIZES = {
  button: {
    xs: { height: '1.5rem', fontSize: 'xs', px: '2' }, // 24px height
    sm: { height: '2rem', fontSize: 'sm', px: '3' }, // 32px height
    md: { height: '2.5rem', fontSize: 'md', px: '4' }, // 40px height (ESTÁNDAR)
    lg: { height: '3rem', fontSize: 'lg', px: '6' }, // 48px height
    xl: { height: '3.5rem', fontSize: 'xl', px: '8' } // 56px height
  },
  input: {
    sm: { height: '2rem', fontSize: 'sm', px: '3' }, // 32px height
    md: { height: '2.5rem', fontSize: 'md', px: '4' }, // 40px height (ESTÁNDAR)
    lg: { height: '3rem', fontSize: 'lg', px: '4' } // 48px height
  },
  avatar: {
    xs: '1.5rem', // 24px
    sm: '2rem', // 32px
    md: '2.5rem', // 40px (ESTÁNDAR)
    lg: '3rem', // 48px
    xl: '4rem', // 64px
    '2xl': '6rem' // 96px
  }
 ...
 *
 * ✅ CORRECTO:
 * <Box p="6" borderRadius="lg" shadow="md" bg="bg.surface">
 * <Button size="md" colorPalette="blue">
 * <Text fontSize="md" fontWeight="medium" color="text.primary">
 *
 * ❌ INCORRECTO:
 * <Box padding="24px" borderRadius="8px" boxShadow="0 4px 6px rgba(0,0,0,0.1)" bg="#ffffff">
 * <Button height="40px" fontSize="16px">
